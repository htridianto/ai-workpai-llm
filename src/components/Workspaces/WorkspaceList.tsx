                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center gap-3 mb-1">
                                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${ws.color ? ws.color : 'bg-gray-200'} text-white`}>
                                ...
                                {isSelected && (
                                    <div className="mt-3 pl-1">
                                        <button
                                            onClick={(e) => { e.stopPropagation(); onEnterChat(ws.id); }}
