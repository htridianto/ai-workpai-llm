...
const DashboardProvider = ({ children })=>{
    ...
    const toggleTheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardProvider.useCallback[toggleTheme]": ()=>{
            setIsDarkMode({
                "DashboardProvider.useCallback[toggleTheme]": (prev)=>{
                    const newVal = !prev;
                ...
                "DashboardProvider.useEffect.fetchData": async ()=>{
                    ...
                    try {
                        ...
                        if (fetchedWorkspaces.length > 0) {
                            ...
                            const wsSessions = fetchedSessions.filter({
                                "DashboardProvider.useEffect.fetchData.wsSessions": (s)=>s.workspaceId === initialWsId
                            }["DashboardProvider.useEffect.fetchData.wsSessions"]);
                            if (wsSessions.length > 0) {
                                const sorted = wsSessions.sort({
    ...
    const updateWorkspaceState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardProvider.useCallback[updateWorkspaceState]": (updatedWs)=>{
            setWorkspaces({
                "DashboardProvider.useCallback[updateWorkspaceState]": (prev)=>prev.map({
                        "DashboardProvider.useCallback[updateWorkspaceState]": (w)=>w.id === updatedWs.id ? updatedWs : w
                    }["DashboardProvider.useCallback[updateWorkspaceState]"])
            }["DashboardProvider.useCallback[updateWorkspaceState]"]);
        }
    }["DashboardProvider.useCallback[updateWorkspaceState]"], []);
...
_s(DashboardProvider, "gxJRdiyfCU0lM/PASL8yiN3EP4o=");
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AVAILABLE_MODELS"].find((m)=>m.id === (currentSession?.modelId || settings.defaultModelId))?.name || 'Model Not Selected'
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/(dashboard)/layout.tsx",
                                                lineNumber: 83,
                                                columnNumber: 15
...
_s(DashboardLayoutContent, "C6p+rIgYsqGJj69zm7riHnWlSMM=", false, function() {
    return [
...
//# sourceMappingURL=src_82e2645f._.js.map